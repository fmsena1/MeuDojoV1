...
__decorate([
    ...
    (0, common_1.UsePipes)(new zod_validation_pipe_1.ZodValidationPipe(class_schema_1.createClassSchema)),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, active_user_decorator_1.ActiveUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [class_schema_1.CreateClassDto, Object]),
...
__decorate([
    (0, common_1.Put)(':id'),
    (0, roles_decorator_1.Roles)(client_1.Role.ADMIN),
    (0, common_1.UsePipes)(new zod_validation_pipe_1.ZodValidationPipe(class_schema_1.updateClassSchema)),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __param(2, (0, active_user_decorator_1.ActiveUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, class_schema_1.UpdateClassDto, Object]),
    __metadata("design:returntype", Promise)
