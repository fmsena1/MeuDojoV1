...
let TransactionsController = class TransactionsController {
    ...
    async findAll(user, type, month, year) {
...
__decorate([
    ...
    (0, common_1.UsePipes)(new zod_validation_pipe_1.ZodValidationPipe(transaction_schema_1.createTransactionSchema)),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, active_user_decorator_1.ActiveUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [transaction_schema_1.CreateTransactionDto, Object]),
